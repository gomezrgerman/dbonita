...
export const TESTIMONIOS: Testimonio[] = [
  {
    ...
    nombre: 'Laura M.',
    ciudad: 'Dénia',
    resena: 'Llevo más de un año siendo clienta y no cambiaría a nadie. Mis uñas siempre quedan perfectas y la atención es increíble. El ambiente del centro es muy relajante, te sientes mimada desde el momento en que entras.',
    estrellas: 5,
    tratamiento: 'Manicura Semipermanente',
  },
  {
    id: 't2',
    nombre: 'Carmen R.',
    ciudad: 'Jávea',
    resena: 'Me hice el lifting de pestañas y el resultado es espectacular. Parezco más despierta y expresiva sin necesitar máscara de pestañas. El efecto dura de verdad lo que prometen, y el trato es siempre cercano y profesional.',
    estrellas: 5,
    tratamiento: 'Lifting de Pestañas',
  },
  {
    id: 't3',
    nombre: 'Sofía V.',
    ciudad: 'Oliva',
    resena: 'Vine desde Oliva expresamente y mereció la pena. Los resultados son visibles desde la primera sesión. Un espacio precioso, muy cuidado, donde de verdad te desconectas. Repetiré sin duda.',
    estrellas: 5,
  ...
  },
  {
    ...
    nombre: 'Ana P.',
    ciudad: 'Dénia',
    resena: 'Me recomendó el laminado de cejas y no me lo podía creer. En 45 minutos pasé de tener las cejas despeinadas a unas cejas perfectas. Natural, con volumen y sin necesitar maquillaje. Mi centro de confianza en Dénia.',
    estrellas: 5,
    tratamiento: 'Laminado de Cejas',
  },
  {
    id: 't5',
    nombre: 'Marta G.',
    ciudad: 'Gandía',
    resena: 'La calidad de los productos y la profesionalidad del centro son de otro nivel. Reservé online en un momento y todo fue perfecto. El espacio transmite mucha calma. Es exactamente la experiencia de bienestar que buscaba.',
    estrellas: 5,
    tratamiento: 'Glow Skin Therapy',
  },
]
